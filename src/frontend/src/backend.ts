...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: number, arg3: bigint, arg4: string, arg5: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createSale(arg0: Array<SaleItem>, arg1: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createSale(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSaleById(arg0: bigint): Promise<Sale> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: bigint, arg5: string, arg6: bigint): Promise<void> {
        if (this.processError) {
            try {
